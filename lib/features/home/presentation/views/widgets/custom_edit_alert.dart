...
class CustomEditAlert extends StatelessWidget {
  const CustomEditAlert({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Center(
        child: ElevatedButton(
          ...
          child: const Text('You are Going to edit user\'details, press to confirm'),
        ),
      ),
    );
  }
